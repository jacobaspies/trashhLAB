...
% amplifier using a Thorlabs direct-drive delay stage.
%
% Inputs:
%   * fig - Figure object for real time plotting
%   * stage - Object for Thorlabs DDS linear translation stage
%   * lock_in - Object for SR810/830 lock-in amplifier
%   * delays - Array of absolute delay times in ps
%   * lock_in_param - Array containing lock-in parameters
%   * timeout - Timeout value for Thorlabs DDS stage
% Outputs:
%   * data - Array of data collected
%   * complete - Iteration of loop completed
